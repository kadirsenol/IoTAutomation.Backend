...
namespace IoTAutomation.EntityLayer.EntityConfig.Abstract
{
    public class BaseEntityConfig<T, TId> : IEntityTypeConfiguration<T> where T : BaseEntity<TId>
    {
        public virtual void Configure(EntityTypeBuilder<T> builder)
        {
            ...
            builder.Property(p => p.Id).ValueGeneratedOnAdd().UseIdentityColumn(1, 1); //Pk tipini byte olarak ayarlayinca ıdentity artirimini otomatik ayarlamiyor.
